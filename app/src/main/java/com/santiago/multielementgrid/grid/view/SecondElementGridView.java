 ...
 */
public class SecondElementGridView extends LinearLayout {

    private TextView textView;

    public SecondElementGridView(Context context) {
        this(context, null);
    }

    public SecondElementGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
